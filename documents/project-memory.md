...
- `Player.gd` currently supports tuned left/right movement, gravity, variable jump height, and sharper jump-cut behavior
- `Player.gd` now also supports one double jump, digging interactions, and a jump sound effect
